              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    fontFamily: 'var(--font-mono)',
                    fontSize: '0.68rem',
                    backgroundColor: isHighlighted ? '#eff6ff' : 'var(--cohere-soft-stone)',
                    border: `1px solid ${isHighlighted ? '#93c5fd' : 'var(--cohere-hairline)'}`,
                    color: isHighlighted ? '#1d4ed8' : 'var(--cohere-ink)',
                    cursor: 'pointer',
                    whiteSpace: 'nowrap',
                    flexShrink: 0,
                  }}
              ...
              return (
                ...
                >
                  ...
                  <div style={{
                    ...
                    color: isSelected ? '#ffffff' : 'var(--cohere-ink)',
                    borderBottom: '1px solid var(--cohere-hairline)',
                  }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', minWidth: 0 }}>
                      <Database01 style={{
                        width: '0.85rem',
                        height: '0.85rem',
                        color: isSelected ? '#ffffff' : 'var(--cohere-primary)',
                        flexShrink: 0
                      }} />
                      <span style={{
                        fontFamily: 'var(--font-mono)',
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.35rem', flexShrink: 0 }}>
                      {tbl.row_count !== undefined && (
                        <span style={{
                          ...
                          color: isSelected ? '#ffffff' : 'var(--cohere-muted)',
                        }}>
                          {tbl.row_count} rows
                        </span>
                      )}
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            fontSize: '0.75rem',
                            borderBottom: idx < tbl.columns.length - 1 ? '1px solid #f3f4f6' : 'none',
                            backgroundColor: col.primary_key ? '#fdf8f6' : (isFk ? '#eff6ff' : 'transparent'),
                          }}
                        >
                          <div style={{ display: 'flex', alignItems: 'center', gap: '0.35rem', minWidth: 0 }}>
                            {col.primary_key ? (
                              <Key01 style={{ width: '0.7rem', height: '0.7rem', color: '#ea580c', flexShrink: 0 }} />
                            ) : isFk ? (
                              <Share04 style={{ width: '0.65rem', height: '0.65rem', color: '#2563eb', flexShrink: 0 }} />
                            ) : (
                            ...
                            <span style={{
                              ...
                              color: col.primary_key ? '#9a3412' : (isFk ? '#1d4ed8' : 'var(--cohere-ink)'),
                              overflow: 'hidden',
                              textOverflow: 'ellipsis',
                              whiteSpace: 'nowrap',
                            }}>
